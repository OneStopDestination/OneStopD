...
class ConstituenciesControllerTest < ActionController::TestCase
  ...
  test "should create constituency" do
    assert_difference('Constituency.count') do
      post :create, constituency: { cid: @constituency.cid, current_MLA: @constituency.current_MLA, name: @constituency.name }
    end
  ...
  test "should update constituency" do
    patch :update, id: @constituency, constituency: { cid: @constituency.cid, current_MLA: @constituency.current_MLA, name: @constituency.name }
    assert_redirected_to constituency_path(assigns(:constituency))
  end
